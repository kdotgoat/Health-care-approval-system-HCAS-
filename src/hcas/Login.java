...
import java.sql.*;
import hcas.DatabaseConnection;
...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        initComponents();
        setResizable(true);
         // Establish connection when Login form initializes
                }
  ...
  private void authenticateUser() {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("HEALTH CARE APPROVAL SYSTEM");

        jLabel5.setIcon(new javax.swing.ImageIcon("E:\\Netbeans\\KNIMS\\src\\icon\\2.13.jpg")); // NOI18N

        jButton3.setBackground(new java.awt.Color(0, 153, 102));
        jButton3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jButton3.setForeground(new java.awt.Color(255, 255, 255));
        jButton3.setText("CLICK TO FILL APPLICATION FORM");
