 ...
 * @author WISE
 */
public class ISTApplication extends javax.swing.JFrame {
 ...
 public void insertData(String idNo, String firstName, String lastName, 
      ...
      try {
            ...
            // SQL Query
            String sql = "INSERT INTO IST (Id_no, First_Name, Last_Name, TypeOfTreatment, Occupation, Amount, Cover, approval_status) VALUES (?, ?, ?, ?, ?, ?, ?, 'Pending')";
    ...
    ISTApplication db = new ISTApplication();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ISTApplication.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ISTApplication().setVisible(true);
            }
        });
    }
